...
import pl.shg.arcade.api.map.region.BreakFlag;
import pl.shg.arcade.api.map.region.Flag;
import pl.shg.arcade.api.map.region.InteractFlag;
import pl.shg.arcade.api.map.region.MoveFlag;
import pl.shg.arcade.api.map.region.PlaceFlag;
import pl.shg.arcade.api.map.region.Region;
import pl.shg.arcade.api.map.region.TeleportFlag;
